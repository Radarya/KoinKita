...
export const TRACKS: Record<string, string> = {
  landing: '/audio/Akustik.mp3',
  dashboard: '/audio/Akustik.mp3',
  'detektif-cuan': '/audio/Mystery.mp3',
  'koki-anggaran': '/audio/Jazz.mp3',
  'tebak-kata': '/audio/Retro.mp3',
  'pohon-aset': '/audio/Synthpop.mp3'
};
